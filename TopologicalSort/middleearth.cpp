// Charles Brady, cjb5ct, 11/15/2020, middleearth.cpp
...
/**
 * @brief Shuffles the city names and their distances 
 *
 * New shuffle method that uses the Mersenne Twister engine
 * @date 11/15/2020
 *
 * @return void 
 * @param first an iterator to the first city name
 * @param last an iterator pointing to the last city name 
 * @param g Mersenne Twister Engine input
 * 
 */
...
/**
 * @brief Creates the Middle-Earth world and generates the distances between
 *
 * computes random city positions
 * 
 * @param xsize an integer representing the x dimension of the Middle Earth 
 * @param ysize an integer representing the y dimension of the Middle Earth
 * @param num_cities an integer representing the number of cities to be made in Middle Earth 
 * @param seed an integer input for the seed of Middle Earth which determines its random dimensions 
 * 
 * @warning {Middle Earth can only create the number of cities which are already
 * in num_city_names,trying to create more than are in num_city_names will exit}
 */
 ...
 *
 * can be loaded into Excel or something simliar 
 * 
 * 
 * 
 */
...
/**
 * @brief This method returns the distance between two passed cities. 
 *
 * If we assume that the hash table (i.e. the map) is O(1),
 * then this method call is also O(1)
 * @return float representing the distance between the citites 
 * @param city1 a string representing the first city 
 * @param city2 a string representing the second city  
 * 
 */
 ...
 * The number of cities passed in does not include this start/end point
 * (so there will be length+1 entries in the returned vector).
 * @return vector representing the list of cities to travel to
 * @param length an integer representing how many cities to travel to  
 * 
 */
